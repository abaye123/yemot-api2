...
function Yemot_api(username, password, config = {}, ym_server = "ym") {
	...
	/**
	 * Upload a file to Yemot
	 * @param {string} path - The path where the file will be uploaded
	 * @param {Buffer} file_buffer - The file buffer to upload
	 * @param {string} content_name - The name of the file
	 * @param {number} convert_audio - Whether to convert audio files (1 for yes, 0 for no)
	 * @param {number} auto_numbering - Whether to use auto numbering (1 for yes, 0 for no)
	 */
	this.upload_file = (path, file_buffer, content_name, convert_audio = 1, auto_numbering = 0) => {
