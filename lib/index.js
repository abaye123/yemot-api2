 ...
 * @param {string|object} usernameOrOptions - Username or object with apiKey and optional systemNumber
 * @param {string} password - Password (optional if using apiKey)
...
function Yemot_api(usernameOrOptions, password, config = {}, ym_server = "ym") {
	...
	if (typeof usernameOrOptions === 'object' && usernameOrOptions.apiKey) {
		...
		token = apiKey;
		if (usernameOrOptions.systemNumber) {
			expectedSystemNumber = usernameOrOptions.systemNumber;
		}
